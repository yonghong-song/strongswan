...
/**
 * Convert a unaligned 32-bit little endian to host order
 */
 ...
 */
static inline void horule32(void *p, u_int32_t x)
{
	u_int32_t r;
 ...
 */
static inline u_int32_t rdc26(u_int32_t v)
{
	return v & ((1 << 26) - 1);
}
 ...
 */
static inline u_int32_t rdc25(u_int32_t v)
{
	return v & ((1 << 25) - 1);
}
 ...
 */
static inline u_int32_t sr26(u_int64_t v)
{
	return v >> 26;
}
 ...
 */
static inline u_int32_t sr25(u_int64_t v)
{
	return v >> 25;
}
 ...
 */
static inline u_int64_t mul64(u_int64_t a, u_int32_t b)
{
	return a * b;
}
 ...
 * out = a + b
 */
static inline void add(u_int32_t out[10], u_int32_t a[10], u_int32_t b[10])
{
	out[0] = a[0] + b[0];
	out[1] = a[1] + b[1];
	out[2] = a[2] + b[2];
 ...
 * out = a - b
 */
static inline void sub(u_int32_t out[10], u_int32_t a[10], u_int32_t b[10])
{
	u_int32_t x;
 ...
 * out = in * scalar
 */
static void scalar_product(u_int32_t out[10], u_int32_t in[10], u_int32_t scalar)
{
	u_int64_t x;
 ...
 * out = a * b
 */
static inline void mul(u_int32_t out[10], u_int32_t a[10], u_int32_t b[10])
{
	u_int32_t r0, r1, r2, r3, r4, r5, r6, r7, r8, r9;
	u_int32_t s0, s1, s2, s3, s4, s5, s6, s7, s8, s9;
	u_int64_t m0, m1, m2, m3, m4, m5, m6, m7, m8, m9;
 ...
 */
static inline void square_times(u_int32_t out[10], u_int32_t in[10], int count)
{
	u_int32_t r0, r1, r2, r3, r4, r5, r6, r7, r8, r9;
	u_int32_t d6, d7, d8, d9;
	u_int64_t m0, m1, m2, m3, m4, m5, m6, m7, m8, m9;
 ...
 * out = in * in
 */
static void square(u_int32_t out[10], u_int32_t in[10])
{
 ...
 */
static void expand(u_int32_t out[10], u_char *in)
{
	u_int32_t x0, x1, x2, x3, x4, x5, x6, x7;
	...
	out[0] = rdc26(                         x0       );
	out[1] = rdc25((((u_int64_t)x1 << 32) | x0) >> 26);
	out[2] = rdc26((((u_int64_t)x2 << 32) | x1) >> 19);
	out[3] = rdc25((((u_int64_t)x3 << 32) | x2) >> 13);
	out[4] = rdc26((                        x3) >>  6);
	out[5] = rdc25(                         x4       );
	out[6] = rdc26((((u_int64_t)x5 << 32) | x4) >> 25);
	out[7] = rdc25((((u_int64_t)x6 << 32) | x5) >> 19);
	out[8] = rdc26((((u_int64_t)x7 << 32) | x6) >> 12);
	out[9] = rdc25((                        x7) >>  6);
}
 ...
 */
static inline void carry(u_int32_t f[10])
{
 ...
 */
static void contract(u_char *out, u_int32_t f[10])
{
	carry(f);
 ...
 */
static void swap_conditional(u_int32_t a[10], u_int32_t b[10], u_int32_t swap)
{
	u_int32_t x0, x1, x2, x3, x4, x5, x6, x7, x8, x9;
 ...
 * Out: b = 2^250 - 2^0
 */
static void pow_two5mtwo0_two250mtwo0(u_int32_t b[10])
{
	u_int32_t t0[10], c[10];
 ...
 * z^(p - 2) = z(2^255 - 21)
 */
static void recip(u_int32_t out[10], u_int32_t z[10])
{
	u_int32_t a[10], t0[10], b[10];
...
{
	u_int32_t nqpqx[10] = {1}, nqpqz[10] = {0}, nqz[10] = {1}, nqx[10];
	u_int32_t q[10], qx[10], qpqx[10], qqx[10], zzz[10], zmone[10];
	u_int32_t bit, lastbit, i;
